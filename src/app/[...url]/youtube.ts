...
export async function transcriptFromYouTubeId(
  ...
  if (!captions?.length) {
    throw new TranscriptError(
      "We hit a rate limit. We are   probably checking on it. You can run the open source code on your own laptop to get around it. https://github.com/nandorojo/you2txt"
    );
  }
